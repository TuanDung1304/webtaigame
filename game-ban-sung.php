...
$total_records = mysqli_query($conn, 'select * from application where theLoai like "%Bắn súng%"')->num_rows;
$total_pages = ceil($total_records/$item_per_page);
#query
$games = executeResult('select * from application where theLoai like "%Bắn súng%" limit '.$item_per_page.' offset '.$offset.'');
...
<div class="container">
    <h2 style="color: white;">Game Bắn súng</h2>
</div>
